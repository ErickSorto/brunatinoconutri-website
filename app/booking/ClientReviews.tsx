...
const reviews = [
  { source: "IMG_8040.webp", topic: ["Comida que você ama", "Food you love"], pt: "Sou muito contente de ter encontrado você Bru, agora eu como de forma mais saudável, mais disposta e não deixo de comer o que amo", en: "I’m so happy I found you, Bru. Now I eat more healthily, have more energy, and still eat what I love." },
  { source: "IMG_8053.webp", topic: ["Energia para se cuidar", "Energy for yourself"], pt: "Essa dieta me deu muita energia, consigo cuidar de mim, o que nem isso eu conseguia antes.", en: "This eating plan has given me so much energy. I can take care of myself, which I couldn’t even do before." },
  { source: "IMG_8039.webp", topic: ["Apoio que faz diferença", "Support that matters"], pt: "Muuitoo obrigada, mas nada disso seria possível sem o seu apoio e seu trabalho.. estou mto feliz com tudo que estou conseguindo mudar ..", en: "Thank you so much. None of this would be possible without your support and your work. I’m so happy with everything I’m managing to change." },
  { source: "IMG_8054.webp", topic: ["Para a vida real", "Made for real life"], pt: "Achei o máximo seu material! Até chocolatinho !!!!! Amei! É isso aí estilo de vida pra sempre!", en: "I thought your material was amazing! Even a little chocolate! I loved it! That’s it—a lifestyle for good!" },
  { source: "IMG_8067.webp", topic: ["Mais disposição", "Feeling better"], pt: "Depois de nossa dieta e tudo. Eu me sinto tão bem. Leve/dormindo melhor. Mais energia.", en: "After our eating plan and everything, I feel so good. Lighter, sleeping better. More energy." },
];
